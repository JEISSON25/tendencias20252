...
DEBUG = False #Se cambia a false para despliegue

ALLOWED_HOSTS = ['.vercel.app', '.now.sh','https://tendencias20252-td7g.onrender.com']
...
MIDDLEWARE = [
    ...
    'apps.pedidos.metrics.RequestMetricsMiddleware',
]
