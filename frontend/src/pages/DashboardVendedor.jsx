  ...
  return (
    <div
      style={{
        ...
        backgroundImage:
          "url('https://www.impulsonegocios.com/wp-content/uploads/2021/04/SUPERMERCADOS-Y-PROVEDORES.jpg')",
    ...
    >
      ...
      <div
        style={{
          ...
          width: "100%",
          height: "100%",
          backgroundColor: "rgba(0, 0, 0, 0.5)", // Ajusta opacidad aquí
          zIndex: 0,
        }}
      />

      {/* Navbar de repartidor funcional */}
      ...
      <div style={{ flex: 1, padding: 30, position: "relative", zIndex: 1 }}>
        <h1
          style={{
            ...
            fontSize: 28,
            color: "#fff",
            marginTop: 80, // separa del navbar
          }}
        >
        ...
        <div style={cardStyle}>
          ...
          <label style={{ display: "flex", alignItems: "center", gap: 5 }}>
            ...
            <input
              ...
              onChange={(e) =>
                setNewProduct({ ...newProduct, disponible: e.target.checked })
              }
            />
          </label>
